...
export default function DropDownMenuItems() {
  ...
  return (
    ...
    <div>
      ...
      <InputLabel id="demo-simple-select-label"><p style={{color:black}}>Category</p></InputLabel> 
        <Select
    ...
    <div>
      <FormControl className={classes.formControl}>
      <InputLabel id="demo-simple-select-label"><p style={{color:black}}>Brands</p></InputLabel>     
         <Select
          labelId="demo-controlled-open-select-label"
          id="demo-controlled-open-select"
          open={openBrands}
    ...
    <div>
      <FormControl className={classes.formControl}>
      <InputLabel id="demo-simple-select-label"><p style={{color:black}}>Colour</p></InputLabel>
        <Select
          labelId="demo-controlled-open-select-label"
          id="demo-controlled-open-select"
          open={openColour}
    ...
    <div>
      <FormControl className={classes.formControl}>
      <InputLabel id="demo-simple-select-label"><p style={{color:black}}>Price Range</p></InputLabel>
        <Select
          labelId="demo-controlled-open-select-label"
          id="demo-controlled-open-select"
          open={openPrice}
